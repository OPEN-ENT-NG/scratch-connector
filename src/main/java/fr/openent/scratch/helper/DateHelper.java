        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    log.error("[Scratch@DateHelper] " + e1.getMessage());
                    log.error("[Scratch@DateHelper] " + e2.getMessage());
                    log.error("[Scratch@DateHelper] " + e3.getMessage());
                    log.error("[Scratch@DateHelper] Failed to format date '" + dateToFormat + "'");
